...
pub fn day_11_test() {
  day_11.pt_1(inputs.day_11)
  |> should.equal(2238)

  day_11.pt_2(inputs.day_11)
  |> should.equal(2013)
}

pub fn day_13_test() {
  day_13.pt_1(inputs.day_13)
  |> should.equal(2092)

  day_13.pt_2(inputs.day_13)
  |> should.equal(702970661767766)
}

pub fn day_14_test() {
  day_14.pt_1(inputs.day_14)
  |> should.equal(9628746976360)

  day_14.pt_2(inputs.day_14)
  |> should.equal(4574598714592)
}
